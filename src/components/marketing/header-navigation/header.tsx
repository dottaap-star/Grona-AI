            ...
            <div className="flex size-full max-w-container flex-1 items-center pr-3 pl-4 md:px-8">
                ...
                >
                    ...
                    <div className="flex items-center gap-3">
                        <ThemeToggle size={isFloating ? "md" : "lg"} />
                        <Button color="secondary" size={isFloating ? "md" : "lg"} className="max-md:hidden">
                            Log in
                        </Button>
                        <Button color="primary" size={isFloating ? "md" : "lg"} className="max-md:hidden">
                            Sign up
                        </Button>
                    </div>
