...
const MobileMenu = () => {
    return (
        <div className="flex flex-col gap-3 px-4 py-6">
            ...
            <Button color="link-gray" size="lg" href="https://app.grona.ai/login">
                Log in
            </Button>
            <Button color="primary" size="lg" href="https://app.grona.ai/signup">
                Get started
            </Button>
        </div>
    );
            ...
            <div className="flex size-full max-w-container flex-1 items-center pr-3 pl-4 md:px-8">
                ...
                >
                    ...
                    <div className={cx("flex items-center max-md:hidden", isFloating ? "gap-3" : "gap-3")}>
                        <Button color="link-gray" size={isFloating ? "md" : "lg"} href="https://app.grona.ai/login">
                            Log in
                        </Button>
                        <Button color="primary" size={isFloating ? "md" : "lg"} href="https://app.grona.ai/signup">
                            Get started
                        </Button>
                    </div>
