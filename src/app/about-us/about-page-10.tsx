...
import { ChartBreakoutSquare, CheckCircle, Command, MessageChatCircle, MessageHeartCircle, MessageSmileCircle, Zap, ZapFast } from "@untitledui/icons";
...
const navList: { label: string; items: { label: string; href: string }[] }[] = [];
